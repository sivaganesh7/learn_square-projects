      ...
      <div className="max-w-md w-full space-y-10">
        ...
        <div className="bg-white bg-opacity-10 backdrop-blur-lg p-10 rounded-lg shadow-xl transform hover:scale-105 transition-all duration-500 border border-blue-500 glow-blue">
          <h3 className="text-xl font-semibold poppins text-blue-300 mb-4">
            {isForgotPassword ? 'Set New Password' : 'Patient Sign In'}
          </h3>
          ...
          {!isForgotPassword ? (
            <form onSubmit={handleLoginSubmit} className="space-y-6">
              <div>
                <label className="block text-gray-300 font-medium poppins mb-2">Email Address</label>
                <input
                  type="email"
                  name="email"
              ...
              <p className="mt-2 text-center text-gray-300 poppins">
                ...
                <Link to="/patient-register" className="text-blue-300 hover:text-blue-500 transition-all duration-300">
                  Register here
                </Link>
              </p>
            </form>
            ...
            <form onSubmit={handleResetPasswordSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="your.email@meditrack.local"
                  className="w-full p-2 border border-gray-600-xxxx rounded-lg bg-gray-800 text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 poppins"
                  required
                />
              </div>
              <div>
