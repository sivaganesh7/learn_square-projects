...
const BookAppointment = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.doctorId || !formData.date || !formData.time || !formData.healthIssue) {
    ...
    try {
      // Fetch patient record to get patientId
                ...
                {doctors.map((doctor) => (
                  ...
                  >
                    <div className="flex justify-between items-center">
                      <span className="text-white poppins">Dr. {doctor.name}</span>
